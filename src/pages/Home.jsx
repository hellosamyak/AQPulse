...
export default function Home() {
  ...
  const imageSrc = isDark ? "/aqi.png" : "/aqilight.png";
  ...
  return (
    <div className="bg-white dark:bg-gray-950 text-gray-800 dark:text-white">
      ...
      <section
        id="why-matters"
        className="min-h-screen py-20 px-6 md:px-12 lg:px-24 flex flex-col justify-center items-center bg-gray-50 dark:bg-gray-950"
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-600 dark:text-cyan-400 mb-12 text-center">
            Why Air Quality Monitoring Matters
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-blue-900/30 dark:hover:shadow-cyan-900/50 transition transform hover:scale-105 flex flex-col items-center text-center">
              <div className="bg-blue-500/10 dark:bg-cyan-500/20 p-4 rounded-full mb-6">
                <Brain size={45} className="text-blue-600 dark:text-cyan-400" />
              </div>
          ...
          <div className="bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 p-8 md:p-12 rounded-2xl shadow-xl">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                <img
                  src={imageSrc}
                  alt="AQI Chart"
                  className="rounded-lg shadow-lg min-w-full h-auto transition-opacity duration-300"
                />
              </div>
      ...
      <section
        id="about"
        className="min-h-screen py-20 px-6 md:px-12 lg:px-24 flex flex-col justify-center bg-white dark:bg-gray-950"
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-600 dark:text-cyan-400 mb-12 text-center">
            About the Project
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <div className="relative">
                <div className="bg-blue-400/20 dark:bg-cyan-400/20 absolute -top-4 -left-4 w-full h-full rounded-xl"></div>
                <img
                  src="/setup.jpeg"
                  alt="Project Setup"
            ...
            <div className="md:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg flex items-center">
                  <div className="bg-blue-500/10 dark:bg-cyan-500/20 p-2 rounded-full mr-4">
                    <Microchip
                      size={20}
                      className="text-blue-600 dark:text-cyan-400"
                    />
              ...
              <NavigateButton
                to="/about"
                className="px-8 py-4 bg-blue-600 dark:bg-cyan-500 text-white font-semibold rounded-lg cursor-pointer text-lg hover:bg-blue-700 dark:hover:bg-cyan-600 transition transform hover:scale-105 shadow-lg hover:shadow-blue-500/50 dark:hover:shadow-cyan-500/50"
              >
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-gray-50 dark:bg-gray-950">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <NavigateButton
            to="/dashboard"
            className="px-10 py-5 bg-blue-600 dark:bg-cyan-500 text-white text-xl font-semibold rounded-lg cursor-pointer hover:bg-blue-700 dark:hover:bg-cyan-600 transition transform hover:scale-105 shadow-lg hover:shadow-blue-500/50 dark:hover:shadow-cyan-500/50"
          >
