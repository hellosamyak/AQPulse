...
export default function About() {
  ...
  return (
    <div className="w-full bg-gray-950 text-gray-100 pb-20 pt-24 px-4 md:px-6 lg:px-8">
      <div className="max-w-screen-xl mx-auto space-y-20">
        <section className="text-center space-y-4">
          <div className="inline-block p-3 rounded-full bg-blue-900/30">
            <CloudLightning size={48} className="text-cyan-400" />
          </div>
          <h1 className="text-4xl font-bold text-white">AQPulse</h1>
          <p className="text-xl text-cyan-300">
            Real-time Air Quality Monitoring
          </p>
          <p className="max-w-2xl text-lg mx-auto text-gray-400">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                icon: <Cpu className="h-6 w-6 text-cyan-400 mr-3" />,
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-10">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-gray-800/40 rounded-xl border border-gray-700/50 overflow-hidden shadow-lg hover:shadow-cyan-900/20 transition-shadow duration-300"
              >
                <div
                  className={`flex flex-col ${
                    index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                  } items-center bg-gradient-to-b from-gray-800/50 to-gray-900/50`}
                >
                  ...
                  <div className="w-full md:w-2/3 p-6 md:p-8 space-y-4 text-center md:text-left">
                    ...
                    <div className="flex justify-center md:justify-start space-x-4 pt-2">
                      <a
                        ...
                        className="p-2 rounded-full bg-gray-700/70 hover:bg-cyan-600/50 transition-colors duration-200 border border-gray-600/50"
                      >
                        <svg
